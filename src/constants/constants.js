export const projects = [
  ...
  },
  {
    ...
    description: "An event finding application for users to explore the public events nearby. Worked with APIs from Google Maps, Geocoding and other third parties. Utilized Google Firestore to store user app data, used Google Cloud Storage to store user content",
    image: '/images/JoinUsApp.png',
  ...
  {
    title: 'Freecell Game',
    description:"Freecell Game developed by Java and Swing",
    image: '/images/freecell.png',
    tags: ['Java', 'Swing'],
...
export const TimeLineData = [
  { year: '2021 Aug', text: 'Decided to switch to Tech industry', },
  { year: '2021 Sept', text: 'Enrolled to Northeastern University to pursue Master Degree',},
  { year: '2022 May', text: 'Joined CodeCore Web Development Bootcamp', },
  { year: 'Ongoing', text: 'Keep learning...' },
];